  ...
  factory Job.fromJson(Map<String, dynamic> json) {
    ...
    String extractCompanyName(Map<String, dynamic> json) {
      return json['company']?['name']?.toString() ??
             ...
             json['postedJobs']?['companyName']?.toString() ??
             json['jobEmployer']?['companyName']?.toString() ??
    ...
    return Job(
      ...
      logoUrl: json['company']?['logoUrl']?.toString() ?? 
               json['company']?['logo']?.toString() ??
               json['postedJobs']?['logoUrl']?.toString() ??
               json['postedJobs']?['logo']?.toString(),
