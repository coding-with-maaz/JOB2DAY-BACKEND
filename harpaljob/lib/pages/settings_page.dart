...
// import 'package:cached_network_image/cached_network_image.dart'; // Temporarily disabled due to package issues
import 'dart:io';
  ...
  Future<void> _clearCache() async {
    ...
    if (confirmed == true) {
      try {
        ...
        // Clear cached network images (temporarily disabled)
        Logger.info('SettingsPage: Skipping cached network image clearing (package not available)');
