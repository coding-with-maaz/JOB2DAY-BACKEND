...
// Interstitial/native ads removed
...
class _CountriesPageState extends State<CountriesPage> {
  ...
  Widget _getCountryFlag(String countryName) {
    ...
    final flag = countryFlags[countryName] ?? '🌍';
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            ...
            fontFamily: 'Apple Color Emoji', // Better emoji rendering on iOS
          ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: _getCountryFlag(country.name),
                      ),
                    ),
