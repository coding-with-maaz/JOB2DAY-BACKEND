    ...
    return JobCard(
      ...
      onTap: () async {
        try {
          ...
          // Ads removed - no longer showing interstitial ads
          print('CountryJobsPage: Interstitial ads removed');
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: _showTodayJobsOnly ? Colors.white : Colors.white.withValues(alpha: 0.2),
                                        borderRadius: BorderRadius.circular(12),
                                      ),
                                      child: Text(
